...
def show_training_status(module):
...
class Generic_UNet(DetectionNet):

    def __init__(self, cf, input_channels, base_num_features, num_classes, num_pool, num_conv_per_stage=2,
        ...
        self.cf = cf
        self.DEFAULT_BATCH_SIZE_3D = cf.default_batch_size_3d
        self.DEFAULT_PATCH_SIZE_3D = cf.default_patch_size_3d
        self.SPACING_FACTOR_BETWEEN_STAGES = cf.spacing_factor_between_stages
        self.BASE_NUM_FEATURES_3D = cf.base_num_features_3d
        self.MAX_NUMPOOL_3D = cf.max_numpool_3d
        self.MAX_NUM_FILTERS_3D = cf.max_num_filters_3d
        self.DEFAULT_PATCH_SIZE_2D = cf.default_patch_size_2d
        self.BASE_NUM_FEATURES_2D = cf.base_num_features_2d
        self.DEFAULT_BATCH_SIZE_2D = cf.default_batch_size_2d
        self.MAX_NUMPOOL_2D = cf.max_numpool_2d
        self.MAX_FILTERS_2D = cf.max_filters_3d
        self.use_this_for_batch_size_computation_2D = cf.use_this_for_batch_size_computation_2D
        self.use_this_for_batch_size_computation_3D = cf.use_this_for_batch_size_computation_3D
        ...
        #self.apply(show_training_status)
    ...
    @staticmethod
    def compute_vram_consumption(patch_size, num_pool_per_axis, base_num_features, max_num_features,
